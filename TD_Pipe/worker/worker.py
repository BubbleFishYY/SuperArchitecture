...
from TD_Pipe.config import (CacheConfig, ModelConfig, ParallelConfig,
                            SchedulerConfig)
from TD_Pipe.model_executor import set_random_seed
from TD_Pipe.model_executor.parallel_utils.communication_op import (
    broadcast_object_list)
from TD_Pipe.sequence import SamplerOutput, SequenceGroupMetadata
from TD_Pipe.worker.cache_engine import CacheEngine
from TD_Pipe.worker.model_runner import ModelRunner
...
def _partition_pipeline_model(model_config: ModelConfig,
    ...
    for pp_rank in range(pp_size):
        ...
        partition_info[pp_rank] = (start, min(start + layer - 1,
                                              num_layers - 1))
        start += layer
